...
- 👨🏽‍💻 Worked at leading tech companies including **[Baidu](https://www.baidu.com/)**, **[KingSoft](https://www.ijinshan.com/)**, and others.
- 🧩 Multi-time **CTO** for AI companies (AIGC, image generation, inference optimization).
- 📱 Developed algorithms for multiple applications: [ToolWiz Photos](https://play.google.com/store/apps/details?id=com.btows.photo), [Mypic](https://play.google.com/store/apps/details?id=com.memepick.mypic), [DOUPAI](https://www.doupai.cc/).
